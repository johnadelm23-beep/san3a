...
export default function PaizoMarquee() {
  ...
  const row1Assets = [
    ...
    { src: 'https://res.cloudinary.com/no25n6db/image/upload/v1788726057/liveit_1_tfcpja.png', title: 'Live It — Session 1', titleAr: 'لايف إت — الفعالية ١' },
    ...
    { src: 'https://res.cloudinary.com/no25n6db/image/upload/v1788726067/liveit_7_rbsdrq.png', title: 'Live It — Session 2', titleAr: 'لايف إت — الفعالية ٢' },
    ...
    { src: 'https://res.cloudinary.com/no25n6db/image/upload/v1788726068/liveit_5_f4529l.png', title: 'Live It — Session 3', titleAr: 'لايف إت — الفعالية ٣' },
  ]
  ...
  const row2Assets = [
    ...
    { src: 'https://res.cloudinary.com/no25n6db/image/upload/v1788726069/liveit_6_wufnqn.png', title: 'Live It — Session 4', titleAr: 'لايف إت — الفعالية ٤' },
    { src: 'https://res.cloudinary.com/no25n6db/image/upload/v1788726056/liveit_4_xa4ha2.png', title: 'Live It Keynote', titleAr: 'لايف إت — الجلسة الرئيسية' },
    { src: 'https://res.cloudinary.com/no25n6db/image/upload/v1788726075/liveit_8_vlygdr.png', title: 'Live It — Session 5', titleAr: 'لايف إت — الفعالية ٥' },
    { src: 'https://res.cloudinary.com/no25n6db/image/upload/v1788726075/liveit_2_qdcrri.png', title: 'Live It — Session 6', titleAr: 'لايف إت — الفعالية ٦' },
    { src: 'https://res.cloudinary.com/no25n6db/image/upload/v1788726079/liveit_3_itbazf.png', title: 'Live It — Session 7', titleAr: 'لايف إت — الفعالية ٧' },
  ]
